...
$(function () {
  ...
  function abc() {
    ...
    $(".blessing3").animate({ top: "600px" }, getNum(), function () {
      flag_3 = true;
      $(this).css('top', '-70px');
    });
    $(".blessing4").animate({ top: "600px" }, getNum(), function () {
      flag_4 = true;
      $(this).css('top', '-70px');
    });
    $(".blessing5").animate({ top: "600px" }, getNum(), function () {
      flag_5 = true;
      $(this).css('top', '-70px');
    });
    $(".blessing6").animate({ top: "600px" }, getNum(), function () {
      flag_6 = true;
      $(this).css('top', '-70px');
    });
  }
  ...
  time_6 = setInterval(function () {
    if (flag_6) {
      flag_6 = false;
      $(".blessing6").animate({ top: "400px" }, getNum(), function () {
        flag_6 = true;
        $(this).css('top', '-70px');
      });
    }
